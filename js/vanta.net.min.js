      ...
      class r extends s.b {
        ...
        genPoint(t, e, i) {
          ...
          if ((this.points || (this.points = []), this.options.showDots)) {
            const t = new n.SphereGeometry(0.25, 12, 12),
        ...
        onInit() {
          ...
          Object(o.e)() && ((t = ~~(0.75 * t)), (e = ~~(0.65 * e)));
          const i = t * t * 2;
          (this.linePositions = new Float32Array(i * i * 3)),
            (this.lineColors = new Float32Array(i * i * 3));
          const s = Object(o.d)(new n.Color(this.options.color)),
            r = Object(o.d)(new n.Color(this.options.backgroundColor));
          this.blending = s > r ? "additive" : "subtractive";
          const h = new n.BufferGeometry();
          h.addAttribute(
            "position",
            new n.BufferAttribute(this.linePositions, 3).setDynamic(!0)
          ),
            h.addAttribute(
              "color",
              new n.BufferAttribute(this.lineColors, 3).setDynamic(!0)
            ),
            h.computeBoundingSphere(),
            h.setDrawRange(0, 0);
          const a = new n.LineBasicMaterial({
            vertexColors: n.VertexColors,
            blending: "additive" === this.blending ? n.AdditiveBlending : null,
            transparent: !0,
          });
          (this.linesMesh = new n.LineSegments(h, a)),
            this.cont.add(this.linesMesh);
          for (let i = 0; i <= t; i++)
            for (let s = 0; s <= t; s++) {
              const n = Object(o.g)(-3, 3),
                r = (i - t / 2) * e + Object(o.g)(-5, 5);
              let h = (s - t / 2) * e + Object(o.g)(-5, 5);
              i % 2 && (h += 0.5 * e),
                this.genPoint(r, n - Object(o.g)(5, 15), h),
                this.genPoint(
                  r + Object(o.g)(-5, 5),
                  n + Object(o.g)(5, 15),
                  h + Object(o.g)(-5, 5)
          ...
          const c = new n.AmbientLight(16777215, 0.75);
          return (
            this.scene.add(c),
        ...
        onUpdate() {
          ...
          this.rayCaster &&
            this.rayCaster.setFromCamera(
              new n.Vector2(this.rcMouseX, this.rcMouseY),
              this.camera
            );
          for (let t = 0; t < this.points.length; t++) {
            ...
            if (
              ...
              (e = Math.sqrt(
                ...
                (t += 25e-5 * l.r),
                (l.position.x = e * Math.cos(t)),
                (l.position.z = e * Math.sin(t));
            }
            for (let c = t; c < this.points.length; c++) {
              ...
              if (
                ...
                (c =
                  ...
                  (this.lineColors[s++] = c.r),
                  (this.lineColors[s++] = c.g),
                  (this.lineColors[s++] = c.b),
                  (this.lineColors[s++] = c.r),
                  (this.lineColors[s++] = c.g),
                  (this.lineColors[s++] = c.b),
                  o++;
        ...
        onMouseMove(t, e) {
          ...
          (i.tz = o * Math.sin(n)),
            (i.tx = o * Math.cos(n)),
            (i.ty = i.oy + 50 * (e - 0.5) * (this.options.mouseCoeffY || 1)),
            this.rayCaster,
            (this.rcMouseX = 2 * t - 1),
            (this.rcMouseY = 2 * -t + 1);
        }
